...
{
    class ClaimResponseBundle_settlement
    {
        public static void Main()
        {
            ...
            {
                string strErrOut = "";
                Console.WriteLine("Inside ClaimResponseBundle_settlement");
                fnBundle_ClaimResponseBundle_settlement(ref strErrOut);
                Console.ReadKey();
            }
            catch (Exception e)
            {
                Console.WriteLine("ClaimResponseBundle_settlement ERROR:---" + e.Message);
            }

        }

        static bool fnBundle_ClaimResponseBundle_settlement(ref string strError_OUT)
        {
            bool blnReturn = true;
            try
            {
                Bundle Bundle_ClaimResponseBundle_settlement = new Bundle();
                Bundle_ClaimResponseBundle_settlement = populateBundle_ClaimResponseBundle_settlement();

                string strErr_OUT = "";
                bool isValid = ResourcePopulator.ValidateProfile(Bundle_ClaimResponseBundle_settlement, ref strErr_OUT);
                //   isValid = true;
                if (isValid != true)
                {
                ...
                {
                    Console.WriteLine("Validated populated ClaimResponseBundle_settlement bundle successfully");
                    bool isProfileCreated = ResourcePopulator.seralize_WriteFile("ClaimResponseBundle_settlement.json", Bundle_ClaimResponseBundle_settlement);
        ...
        static Bundle populateBundle_ClaimResponseBundle_settlement()
        {
            // Set metadata about the resource            
            Bundle Bundle_ClaimResponseBundle_settlement = new Bundle()
            {
                // Set logical id of this artifact
                Id = "ClaimResponseBundle-settlement-01",
                Meta = new Meta()
                {
                    VersionId = "1",
            ...
            // Set Bundle Type 
            Bundle_ClaimResponseBundle_settlement.Type = Bundle.BundleType.Collection;
            ...
            Bundle_ClaimResponseBundle_settlement.Identifier = identifier;

            ////// Set Timestamp  
            var dtStr = "2020-07-09T15:32:26.605+05:30";
            Bundle_ClaimResponseBundle_settlement.TimestampElement = new Instant(DateTime.Parse(dtStr));


            var bundleEntry1 = new Bundle.EntryComponent();
            bundleEntry1.FullUrl = "urn:uuid:03acb7b0-3833-45a0-9885-ad35940a3458";   // "ClaimResponse/ClaimResponse-settlement-01";
            bundleEntry1.Resource = ResourcePopulator.populateClaimResponsesettlement();
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry1);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry2);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry3);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry4);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry5);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry6);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry7);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry8);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry9);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry10);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry11);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry12);
            ...
            Bundle_ClaimResponseBundle_settlement.Entry.Add(bundleEntry13);

            return Bundle_ClaimResponseBundle_settlement;
        }
    }
}
