...
{
    class ClaimBundleResource_preauth
    {
        public static void Main()
        {
            ...
            {
                string strErrOut = "";
                Console.WriteLine("Inside ClaimBundleResource_preauth");
                fnClaimBundleResource_preauth(ref strErrOut);
                Console.ReadKey();
            }
            catch (Exception e)
            {
                Console.WriteLine("ClaimBundleResource_preauth ERROR:---" + e.Message);
            }

        }
        static bool fnClaimBundleResource_preauth(ref string strError_OUT)
        {
            bool blnReturn = true;
            try
            {
                Bundle ClaimBundleResource_preauth = new Bundle();
                ClaimBundleResource_preauth = populateClaimBundleResource_preauth();

                string strErr_OUT = "";
                bool isValid = ResourcePopulator.ValidateProfile(ClaimBundleResource_preauth, ref strErr_OUT);
                //   isValid = true;
                if (isValid != true)
                {
                ...
                {
                    Console.WriteLine("Validated populated ClaimBundleResource_preauth bundle successfully");
                    bool isProfileCreated = ResourcePopulator.seralize_WriteFile("ClaimBundleResource_preauth.json", ClaimBundleResource_preauth);
        ...
        static Bundle populateClaimBundleResource_preauth()
        {
            // Set metadata about the resource            
            Bundle ClaimBundleResource_preauth = new Bundle()
            {
                // Set logical id of this artifact
                Id = "ClaimBundle-preauth-01",
                Meta = new Meta()
                {
                    VersionId = "1",
            ...
            ClaimBundleResource_preauth.Identifier = identifier;

            // Set Bundle Type 
            ClaimBundleResource_preauth.Type = Bundle.BundleType.Collection;

            ////// Set Timestamp  
            var dtStr = "2023-12-13T15:32:26.605+05:30";
            ClaimBundleResource_preauth.TimestampElement = new Instant(DateTime.Parse(dtStr));

            var bundleEntry1 = new Bundle.EntryComponent();
            bundleEntry1.FullUrl = "urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b";
            bundleEntry1.Resource = ResourcePopulator.populateClaimpreauthResource();
            ClaimBundleResource_preauth.Entry.Add(bundleEntry1);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry2);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry3);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry4);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry5);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry6);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry7);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry8);
            ...
            ClaimBundleResource_preauth.Entry.Add(bundleEntry9);
             
            return ClaimBundleResource_preauth;
        }
    }
}
